...
print("The average is: ", average_loan_amount) 
...
def new_loan(loan_price, remaining_months,future_value, annual_discount_rate): 
    present_value = new_loan - loan_price
...
csvpath = Path("inexpensive_loans")
...
with open(csvpath, "w") as csvfile:
    ...
    for price in inexpensive_loans:
        csvwriter.writerow(price.values())
